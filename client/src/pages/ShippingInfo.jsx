                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <section className="bg-gray-50 rounded-2xl p-8 border border-gray-100 flex flex-col items-center text-center">
                                ...
                                <p className="text-gray-600 text-sm leading-relaxed">
                                    Si prefieres recibir el paquete en la puerta de tu casa, podrás seleccionar esta opción al finalizar tu compra. Este servicio cuenta con un costo fijo de <strong>$4.490</strong> a cualquier punto del país.
                                </p>
                            </section>
                        </div>
