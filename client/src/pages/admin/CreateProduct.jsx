...
import { Upload, Loader, ArrowLeft, ArrowRight, X, Star, Move, Maximize2 } from 'lucide-react';
        ...
        <div className="max-w-3xl mx-auto p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="space-y-4">
                    ...
                    {/* Grilla de Previsualización con Controles de Botón */}
                        ...
                        >
                            {managedImages.map((item, index) => (
                                <motion.div
                                    ...
                                    className="relative aspect-square rounded-xl overflow-hidden border border-gray-200 bg-white shadow-sm group"
                                >
                                    <img src={item.url} alt="Preview" className="w-full h-full object-cover" />
                                    
                                    {/* Overlay de Control (Solo visible al hover o siempre en mobile) */}
                                    ...
                                    {form.allowInitials && (
                                        <motion.div
                                            ...
                                            onDragEnd={(e, info) => {
                                                ...
                                                // Calcular el centro del elemento relativo al contenedor
